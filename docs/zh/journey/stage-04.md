...
??? note "文件差异：tests/unit/sql/test_parser_ddl_dml.py"
    ```diff
...
??? note "文件差异：tests/unit/sql/test_parser_precedence.py"
    ```diff
...
??? note "文件差异：tests/unit/sql/test_parser_select.py"
    ```diff
...
??? note "文件差异：src/minipostgres/sql/ast.py"
    ```diff
...
??? note "文件差异：src/minipostgres/sql/parser.py"
    ```diff

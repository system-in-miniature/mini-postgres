# Stage 13 · Persistent BTree core
...
??? note "File diff: tests/integration/test_btree_restart.py"
    ```diff
...
??? note "File diff: tests/property/test_btree_multimap.py"
    ```diff
...
??? note "File diff: tests/property/test_key_order.py"
    ```diff
...
??? note "File diff: tests/unit/index/test_btree_delete.py"
    ```diff
...
??? note "File diff: tests/unit/index/test_btree_insert.py"
    ```diff
...
??? note "File diff: tests/unit/index/test_btree_pages.py"
    ```diff
...
??? note "File diff: tests/unit/index/test_btree_range.py"
    ```diff
...
??? note "File diff: tests/unit/index/test_key_codec.py"
    ```diff
...
??? note "File diff: src/minipostgres/index/iterator.py"
    ```diff
...
??? note "File diff: src/minipostgres/index/key.py"
    ```diff
...
??? note "File diff: src/minipostgres/index/pages.py"
    ```diff

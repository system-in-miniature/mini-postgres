# Stage 27 · Maintenance domain closure
...
??? note "File diff: tests/acceptance/test_behavior_matrix.py"
    ```diff
...
??? note "File diff: tests/concurrency/test_hot_visibility.py"
    ```diff
...
??? note "File diff: tests/differential/test_postgres18.py"
    ```diff
...
??? note "File diff: tests/integration/test_hot_fallback.py"
    ```diff
...
??? note "File diff: tests/integration/test_hot_pruning.py"
    ```diff
...
??? note "File diff: tests/integration/test_vacuum_metadata.py"
    ```diff
...
??? note "File diff: tests/property/test_vacuum_idempotence.py"
    ```diff
...
??? note "File diff: tests/reliability/test_vacuum_recovery.py"
    ```diff
...
??? note "File diff: src/minipostgres/acceptance.py"
    ```diff
...
??? note "File diff: src/minipostgres/differential/postgres.py"
    ```diff
...
??? note "File diff: src/minipostgres/maintenance/vacuum.py"
    ```diff

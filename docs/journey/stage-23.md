# Stage 23 · Recovery and deadlock victims
...
??? note "File diff: tests/concurrency/test_deadlock.py"
    ```diff
    diff --git a/tests/concurrency/test_deadlock.py b/tests/concurrency/test_deadlock.py
    new file mode 100644
    index 0000000000000000000000000000000000000000..8c36ab4504e4bc9438d4ae906c08ed0c593b0f1d
    --- /dev/null
...
??? note "File diff: tests/concurrency/test_unique_conflicts.py"
    ```diff
    diff --git a/tests/concurrency/test_unique_conflicts.py b/tests/concurrency/test_unique_conflicts.py
    new file mode 100644
    index 0000000000000000000000000000000000000000..51465bd6dd1278beb8ca72b7995a81299c5251ca
    --- /dev/null
    +++ b/tests/concurrency/test_unique_conflicts.py
    @@ -0,0 +1,29 @@
    +from concurrent.futures import ThreadPoolExecutor
    +
    +import pytest
...
??? note "File diff: tests/concurrency/test_write_conflicts.py"
    ```diff
    diff --git a/tests/concurrency/test_write_conflicts.py b/tests/concurrency/test_write_conflicts.py
    new file mode 100644
    index 0000000000000000000000000000000000000000..d5ac5cfa3f06d2b94f3719f81e849834b3c3a02b
    --- /dev/null
...
??? note "File diff: tests/unit/wal/test_control_file.py"
    ```diff
    diff --git a/tests/unit/wal/test_control_file.py b/tests/unit/wal/test_control_file.py
    new file mode 100644
    index 0000000000000000000000000000000000000000..aa687465a3a106a50af4311c005b2b45ee8ae564
    --- /dev/null
    +++ b/tests/unit/wal/test_control_file.py
    @@ -0,0 +1,24 @@
...
??? note "File diff: tests/unit/wal/test_recovery.py"
    ...
    new file mode 100644
    index 0000000000000000000000000000000000000000..3a3c28eb35516959da587e3719bb929aae819088
    --- /dev/null
...
??? note "File diff: src/minipostgres/engine.py"
    ...
    index eeec9a03ecfc22c154cc52fce3c0280c44eb9a3c..205ababea3b614947c1f28c17efe4a1580d959eb 100644
...
??? note "File diff: src/minipostgres/executor/base.py"
    ...
    index 89fec93c339526569c6b92b457b44e061a985230..df6b323cbbb8a3d64ab5e7cfde1ae1de951c6968 100644
...
??? note "File diff: src/minipostgres/executor/operators.py"
    ...
    index b31054a6d2f0a5cecbce67ccc54686371f8f5b5d..eff6f13f87be893b56d334c8dac099177e8851aa 100644
    ...
    @@ -646,9 +654,15 @@ def _has_mvcc(context: ExecutionContext) -> bool:
...
??? note "File diff: src/minipostgres/storage/heap.py"
    ...
    index 7beac4546a2e2ab2a03acb52a0bffe589ff0f4bd..db90994b3d595b82b1b3f299c384d5666cad3da5 100644
...
??? note "File diff: src/minipostgres/storage/indexed.py"
    ...
    index 372d20a290e1eba7c52c9bc1450b8ecb4f7d4702..198299289315deccfc17e97c9f834fd748e0f823 100644
    ...
    +        transaction.has_writes = True
             ...
             return tid
    @@ -150,35 +158,70 @@ class IndexedTableAccess:
         def replace_mvcc(
             self,
             tid: TID,
    -        xid: int,
    ...
    @@ -218,10 +261,9 @@ class IndexedTableAccess:
                     )
    ...
    -        snapshot: Snapshot,
             ...
             statuses: TransactionStatusTable,
             *,
    @@ -231,18 +273,46 @@ class IndexedTableAccess:
...
??? note "File diff: src/minipostgres/transaction/manager.py"
    ...
    index f86afac47ccd3458da382d50d68d8f19c746d4b1..2122169a8de1bb955033c9dd0658863e50c1c54a 100644
...
??? note "File diff: src/minipostgres/wal/control_file.py"
    ...
    new file mode 100644
    index 0000000000000000000000000000000000000000..6c46c8dcc11b6ec94518bb38d7b64444aef0c847
    --- /dev/null
...
??? note "File diff: src/minipostgres/wal/recovery.py"
    ...
    new file mode 100644
    index 0000000000000000000000000000000000000000..3908c06abfbd3ef83100c89588787092bc4332c3
    --- /dev/null
...
[Complete reference patch / 完整参考补丁](https://github.com/system-in-miniature/mini-postgres/blob/main/journey/stages/23-recovery-deadlock/stage.patch)

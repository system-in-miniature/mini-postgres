# Stage 17 · Optimizer and instrumentation
...
??? note "File diff: tests/contract/test_explain_analyze.py"
    ```diff
...
??? note "File diff: tests/integration/test_index_scan_results.py"
    ```diff
...
??? note "File diff: tests/integration/test_instrumentation_cleanup.py"
    ```diff
...
??? note "File diff: tests/integration/test_join_algorithm_results.py"
    ```diff
...
??? note "File diff: tests/property/test_join_order_equivalence.py"
    ```diff
...
??? note "File diff: tests/unit/planner/test_join_choice.py"
    ```diff
...
??? note "File diff: tests/unit/planner/test_join_order.py"
    ```diff
...
??? note "File diff: tests/unit/planner/test_scan_choice.py"
    ```diff
...
??? note "File diff: src/minipostgres/executor/factory.py"
    ```diff
...
??? note "File diff: src/minipostgres/executor/instrumentation.py"
    ```diff
...
??? note "File diff: src/minipostgres/planner/explain.py"
    ```diff
...
??? note "File diff: src/minipostgres/planner/memo.py"
    ```diff
...
??? note "File diff: src/minipostgres/planner/optimizer.py"
    ```diff

# Stage 26 · Vacuum, HOT, and crash matrix
...
??? note "File diff: tests/acceptance/test_phase_d.py"
    ```diff
...
??? note "File diff: tests/crash/test_checkpoint_matrix.py"
    ```diff
...
??? note "File diff: tests/crash/test_commit_matrix.py"
    ```diff
...
??? note "File diff: tests/integration/test_hot_update.py"
    ```diff
...
??? note "File diff: tests/integration/test_vacuum_reuse.py"
    ```diff
...
??? note "File diff: tests/reliability/test_engine_recovery.py"
    ```diff
...
??? note "File diff: tests/unit/maintenance/test_coordinator.py"
    ```diff
...
??? note "File diff: tests/unit/wal/test_wal_manager.py"
    ```diff
...
??? note "File diff: src/minipostgres/maintenance/coordinator.py"
    ```diff
...
??? note "File diff: src/minipostgres/testing/failpoints.py"
    ```diff

...
REPO_URL = "https://github.com/system-in-miniature/mini-postgres"
META = re.compile(
...
def role_rank(path: str) -> int:
    if path.startswith(("src/minipostgres/index/", "src/minipostgres/storage/")):
        return 0
    if path.startswith("src/minipostgres/"):
        return 1
    ...
    for card in cards:
        ...
        chapter_link = (
            ...
            + {
                ...
                7: "07-execution.md",
                8: "08-isolation.md",
                9: "09-locks-deadlock.md",
                10: "10-wal-recovery.md",
                11: "11-vacuum-hot.md",
                12: "12-testing-methodology.md",
            }[card.chapter]
        )
        lines.append(

# Stage 03 · Frozen SQL lexer / 冻结 SQL 词法器
...
<!-- journey-file: tests/property/test_lexer_literals.py -->
<!-- journey-file: tests/unit/sql/test_lexer.py -->
#### Frozen SQL lexer test evidence
...
<!-- journey-file: src/minipostgres/sql/lexer.py -->
<!-- journey-file: src/minipostgres/sql/tokens.py -->
...
<!-- journey-file: src/minipostgres/sql/__init__.py -->
